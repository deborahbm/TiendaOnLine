...
<head>
    <meta charset="UTF-8">
    <meta name="" content="">
    <title>TOPE: Índex cliente</title>
...
<body class="fixed-header">
        ...
        <body class="fixed-header">
            ...
            <li class="dropdown"><a href="">Cesta de la compra  <img src="imagenes/styled-select-arrow.png" alt=""></a>
                <ul class="dropdown-menu">
                    <li><a href="inicioSesion.jsp">Cesta de la compra actual</a></li>
                    <li><a href="formularioRegistro.jsp">Compras anteriores</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown"><a href="">Tienda</a>
        ...
        <div class="footer-top clearfix">
            ...
            <div class="footer-aling">
                <div class="footer-address-widget clearfix">
                    <ul>
                        <li><img src="imagenes/savethegreen/icono-telefono2.jfif" width="25px" height="25px" class="espacioDerecha"><strong>971 29 17 56</strong><a href="mailto:support@advisor.com">tope@savethegreen.com</a></li>
                        <li><img src="imagenes/savethegreen/icono-direccion2.jfif" width="20px" height="20px" class="espacioDerecha espacioAbajo"><strong>Madrid</strong><span>C/ Julián Camarillo, Madrid</span></li>
                    </ul>
                </div>
