...
<body class="fixed-header">
    ...
    <!--FIN ENCABEZADO PÁGINA-->
                ...
                <h1 class="color-default">Inicia sesión</h1> 
           <form action="UsuarioFormularioServlet" method="get" name="mensaje" id="mensaje">
            ...
            <div class="request-a-callback clearfix animate fadeInUp">
                <div class="request-a-callback-content">
                    <p>¿Ya estás registrado/a? Introduce tus datos e inicia tu sesión</p>
                ...
                <div class="request-a-callback-form">
                    <form>
                        ...
                        <button data-text="Iniciar sesión" class="btn btn-primary">Iniciar sesión</button>
                    </form>
                </div>
            </div>
