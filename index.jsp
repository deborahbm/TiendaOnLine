                ...
                <div class="services text-center">
                    <div class="three-items-carousel owl-carousel">
                        ...
                        <div class="service-box animate fadeInUp" data-delay="200" id="c-6">
                            <img src="imagenes/color-scheme/green/icon9.png" style="margin-left: 100px; width: 100px">
                            <h4>FAQs</h4>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6 animate fadeInLeft">
                        <ul class="image-list-classic ">
                            <li><img src="imagenes/savethegreen/naranjasCampo.jpeg" alt="" class="redondeado"></li>
                            <li><img src="imagenes/savethegreen/tomates.jpeg" alt="" class="redondeado"></li>
                        </ul>
                    </div>
                    <div class="col-md-6 animate fadeInRight">
        ...
        <section class="meet-our-advisors">
            <div class="container">
                ...
                <div class="single-item-carousel owl-carousel">
                    ...
                    <div class="row">
                        <div class="col-md-5"><img src="imagenes/savethegreen/hombre3.jpeg" height="305px"></div>
                        <div class="col-md-7">
                            <div class="meet-advisors-content">
