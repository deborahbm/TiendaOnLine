	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		switch(usuario.getTipo()) {
			...
			case 2: // Caso del Cliente..
				response.sendRedirect(request.getContextPath() + "/productos"); // redirige al servlet para el cliente,
																				// para que vea directamente los
																				// productos,después de haberse logueado.
				break;
			}
